export const projects = [
	...
	{
		slug: "bartender",
		title: "At Home Bartender",
		environment: "MSOE - Junior Project",
		year: "2024 - 2025",
		description:
			"A virtual recipe book and bartender assistant. Users can upload drink recipes via a csv file, and then browse and search through large collections of drinks, ingredients, and different cocktails",
		stack: ["React", "JavaScript", "SQL", "Node.js"],
        repo: "https://github.com/Theodore-Rett/bartender"
	},
	{
		slug: "project-diana",
		title: "Project Diana",
